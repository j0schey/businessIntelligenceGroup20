...
public class RandomGenerator
{
    ...
    private static String OUTPUT_FILENAME = "output(smallMVOnAllDataSet).arff";

    private static int SEED = 2;

    private static double OVERALL_PERCENTAGE_MISSING = 0.1;
    ...
    public static void main(String[] args) {
        ...
        try(BufferedReader br = new BufferedReader(new FileReader(INPUT_FILENAME))) {
            ...
            for(int i = 0; i < data.size(); i++) {
                ...
                for(int j=0; j< (line.numAttributes()-1); j++) {
